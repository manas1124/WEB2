...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../Source/assets/bootstrap-5.3.2-dist/css/bootstrap.css" />
    <title>Login</title>
  </head>
  ...
  <body>
    ...
    <div class="form-container sign-up">
            ...
            <input type="text" placeholder="nhóm khảo sát" id="ks" name="KhaoSat" />
            <input type="text" placeholder="Loại đối tượng" id="dt" name="DoiTuong" />
            <input type="text" placeholder="Chương trình đào tạo" id="ctdt" name="CTDT" />
            
            
            <button type="button" class="btn btn-primary" id="signUpButton">Đăng kí</button>
        </form>
      ...
      <div class="form-container sign-in">
        <form>
          ...
          <button type="button" class="btn btn-primary" id="signInButton">Đăng nhập</button>
        </form>
      </div>
