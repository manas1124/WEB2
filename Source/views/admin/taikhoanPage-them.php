    ...
    <div class="flex justify-center">
        ...
        <div class="flex flex-row">
            <div class="modal-body pt-0 mb-4">
                ...
                <div class="w-96">
                    <label class="label-text" for="select-nganh">Mật khẩu </label>
                    <input type="password" placeholder="" class="input" id="password" />
                </div>
                <div class="w-96">
                    <label class="label-text" for="select-nganh">Mã đối tượng </label>
                    <input type="text" placeholder="" class="input" id="ma-doi-tuong" />
                </div>
                <div class="w-96">
