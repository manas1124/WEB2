<div id="loaitraloi-content" class="container h-full">
    <div class="flex items-center justify-between mb-4">
        <h1>Quản lý loại trả lời</h1>
        <div class="flex items-center gap-4">
            ...
            <button type="button" class="action-item btn btn-primary create-program hidden" data-act="ltl-them">Thêm loại trả lời</button>
        </div>
    </div>
    <div class="flex items-center justify-between mb-4">
        <div class="flex items-center gap-4">
    ...
    <div class="flex items-center justify-between mb-4">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <button type="button" class="btn btn-primary" id="btn-loc" data-act="loaitraloi-loc">Lọc</button>
            </div>
            <div>
...
<script src="./views/javascript/qlLoaiTraLoi.js"></script>