          ...
          $("#account-list").append(`
            <tr>
              ...
              <td class="text-center">
                ${
                  item.status == 1
                    ? '<span class="badge badge-soft badge-success">Đang hoạt động</span>'
                    : '<span class="badge badge-soft badge-error">Ngừng hoạt động</span>'
                }
              </td>
              <td>
                <button class="btn btn-circle btn-text btn-sm action-item" data-act="tk-sua" data-id="${item.tk_id}" aria-label="Sửa tài khoản">
                  <span class="icon-[tabler--pencil] size-5"></span>
                </button>
                <button class="btn btn-circle btn-text btn-sm action-item" data-act="tk-xoa" data-id="${item.tk_id}" aria-label="Xoá tài khoản">
